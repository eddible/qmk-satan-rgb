...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |--------------------------------------------------- Return |
   * |CAPS/FL|  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;| '| #|     |
   * |-----------------------------------------------------------|
   * |Shft | \ |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift    |
   * |-----------------------------------------------------------|
   * |Ctrl|Gui |Alt |      Space            |_MV |ALT |GUI |CTRL |
   * `-----------------------------------------------------------'
   */
[_BW] = KEYMAP(
  F(0),    KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,  KC_EQL,   KC_BSPC,     \
  KC_TAB,  KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,   KC_LBRC,  KC_RBRC,               \
  F(11),   KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN, KC_QUOT,  KC_NUHS,    KC_ENT,  	\
  KC_LSFT, KC_NUBS, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH,            KC_RSFT,   \
  KC_LCTL, KC_LGUI, KC_LALT,         KC_SPC,                                       F(9),  KC_RALT,  KC_RGUI, KC_RCTL),
...
[_FL] = KEYMAP(
  ...
  KC_     TRNS,KC_TRNS,KC_UP,  KC_TRNS,KC_CALC,KC_INS, KC_TRNS,KC_PGUP,KC_TRNS, KC_TRNS,   KC_PSCR,   KC_SLCK,   KC_PAUS,		    \
  KC_TRNS,KC_LEFT,KC_DOWN,KC_RGHT,KC_TRNS,KC_HOME,KC_LEFT,KC_DOWN,KC_UP,   KC_RGHT,   KC_END,    KC_TRNS,   KC_TRNS,   KC_TRNS, \
  KC_TRNS,BL_DEC, BL_TOGG,BL_INC, M(0),   KC_TRNS,KC_PGDN,KC_TRNS, KC_VOLD,   KC_MUTE,   KC_VOLU,   KC_TRNS,   KC_PGUP, \
...
[_MV] = KEYMAP(
  ...
  KC_NO,  KC_NO,  KC_UP,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  BL_TOGG,  BL_DEC, BL_INC, \
  KC_NO,  KC_LEFT,KC_DOWN,KC_RGHT,KC_NO,  KC_HOME,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_END, KC_NO,  KC_NO,  KC_NO, \
  KC_NO,  KC_NO,      F(1),   F(2),   F(3),   F(4),   F(5),   F(6),   F(7),   F(8), KC_NO,  KC_NO,          KC_UP, \
